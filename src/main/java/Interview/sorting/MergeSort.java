...
public class MergeSort {
    ...
    void mergeSort(int arr[], int left, int right)       //helper function that creates the sub cases for Interview.sorting
    {
        int middle;
        if (left < right) {                             //sort only if the left index is lesser than the right index (meaning that Interview.sorting is done)
            middle = (left + right) / 2;
